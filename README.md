...
- Node.js 18+
- Python 3.9+
- [Graphviz](https://graphviz.org/download/) system binary (`dot` must be on your PATH)
...
1. Drop in / select an ER diagram image.
2. (Optional) change the vision/text model names if you're using different
   Ollama models (e.g. `bakllava`, `llama3.1`, `mistral`).
3. Click **Interpret diagram**.
4. Review the refined diagram, JSON schema, and SQL in the tabs.
5. Download any of the three outputs.
